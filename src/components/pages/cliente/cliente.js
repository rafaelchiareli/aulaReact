...
import { DeleteCliente, GetClientes, ListarTipos, PostCliente, PutCliente } from "../../../services/serviceCliente";
...
const Cliente = () => {
    ...
    useEffect(() => {
        ...
        ListarTipos().then(res => { setTipos(res.data); console.log("tipos", res.data) })
                        ...
                        <div>
                            ...
                            <select  onChange={(e) => handleChange(e,e.target.value)}>
                                {tipos && tipos.map(item => (
                                    ...
                                    <option value={item.tipCodigo}>{item.tipDescricao}</option>
                                )) }
                            </select>
                        </div>
                    </div>
